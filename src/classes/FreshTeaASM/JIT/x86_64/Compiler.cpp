...
zend_class_entry *ce_ltp_FreshTeaASM_JIT_x86_64_Compiler;
 ...
 * @param string $code
 */
static PHP_METHOD(ltp_FreshTeaASM_JIT_x86_64_Compiler, __construct) {
  char *code;
  size_t code_len;
  zval *_this;
...
static PHP_METHOD(ltp_FreshTeaASM_JIT_x86_64_Compiler, compile) {
  ...
  _this = getThis();
  code_zv = zend_read_property(ce_ltp_FreshTeaASM_JIT_x86_64_Compiler, _this, ZEND_STRL("code"), 1, &rv TSRMLS_CC);
